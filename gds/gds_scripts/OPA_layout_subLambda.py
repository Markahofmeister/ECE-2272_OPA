...
if(duplicate):     
    ...
    for copy in range(numCopies):
        ...
        gc = gc_cornerstone_pdk_subLambda(width_grating=gratingWidths[copy], nPeriods=numGCPeriods)
        ...
        text = gf.components.texts.text(text = "GC1, WIDTH = " + str(gratingWidths[copy]) + " um", size = 28, position = pos, layer=(100,0), justify="right")
